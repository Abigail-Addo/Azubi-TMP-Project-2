                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <tbody>
                                {order.orderItems.map((item) => (
                                    <tr key={item.product}>
                                        ...
                                        <td className="p-2 text-start">${(item.qty * item.price).toFixed(2)}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="rounded-lg p-4 border border-[#D9D9D9] flex flex-col gap-6">
                        <div className="space-y-2">
                            ...
                            <p>
                                <span className="text-[#003087]">Name:</span> {currentUser?.username || "N/A"}
                            </p>
                            <p>
                                <span className="text-[#003087]">Email:</span> {currentUser?.email || "N/A"}
                            </p>
                            <p>
                            ...
                            <p>
                                <span className="text-[#003087]">Payment Method:</span> {order.paymentMethod}
                            </p>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <p>
                                <span className="text-[#003087]">Items:</span> ${order.itemsPrice.toFixed(2)}
                            </p>
                            <p>
                                <span className="text-[#003087]">Shipping:</span> ${order.shippingPrice.toFixed(2)}
                            </p>
                            <p>
                                <span className="text-[#003087]">Tax:</span> ${order.taxPrice.toFixed(2)}
                            </p>
                            <p className="font-bold">
                                <span className="text-[#003087]">Total:</span> ${order.totalPrice.toFixed(2)}
                            </p>
                        </div>
                    </div>
                </div>
